...
const Donations = () => {
  ...
  useEffect(() => {
    const filteredDonations = donate.filter(
      (don) =>
          ...
          {filteredDonations.length > 0 ? (
            <>
              {filteredDonations.map((j, index) => (
                <div className="card job-list mb-4" key={index}>
                  <div className="card-body">
                    <div className="row align-items-center justify-content-center text-center h-100">
                      <div className="">
                        <div>
                          <span className="filter-txt h4 mr-5">
                            <strong>
                              <FaBuilding /> {j.title}
                            </strong>
                          </span>
                          <span className="filter-txt h4">
                            <strong>
                              <FaRupeeSign />
                              {j.amount_collected} / {j.total_amount}
                            </strong>
                          </span>
                        </div>
                        <hr />
                        <p
                          ...
                          className="truncate filter-txt h5"
                        ></p>
                        <hr
                          className="divider"
